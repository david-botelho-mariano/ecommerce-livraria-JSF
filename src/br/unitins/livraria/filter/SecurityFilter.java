package br.unitins.livraria.filter;
...
public class SecurityFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (usuario == null) {
			((HttpServletResponse) response).sendRedirect("/Livraria/faces/login.xhtml");
		} else {
			...
			((HttpServletResponse) response).sendRedirect("/Livraria/faces/acessonegado.xhtml");
		}
	}
